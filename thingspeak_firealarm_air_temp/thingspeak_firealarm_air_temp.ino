...
void loop() 
{
  ...
  String data = "GET /update?api_key="+ API+"&"+ field1 +"="+String(airSensor)+"&"+ field2 +"="+String(flameSensor)+"&"+field3+"="+String(smokeSensor)+"&"+field4+"="+String(temp)+"&"+field5+"="+String(hum); // Url to send data to ThingSpeak Channel
